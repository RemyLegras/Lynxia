      ...
      <main className="flex-1 ml-64 min-h-screen">
        ...
        <header className="h-16 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-10">
          <div className="flex items-center gap-2">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Upload</h2>
          </div>
              ...
              <div className="xl:col-span-5 flex flex-col gap-6">
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-primary/10 shadow-sm p-6">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-primary/5 border border-primary/10 mb-6">
                    ...
                    <div>
                      <p className="text-lg font-bold leading-tight">Authentic</p>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 gap-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                          <label className="text-xs font-semibold text-slate-400 uppercase">DOB</label>
                          <input className="w-full bg-slate-50 dark:bg-slate-800 border-primary/20 rounded-lg px-3 py-2 text-sm font-medium border-transparent" type="text" defaultValue="12 MAY 1988"/>
                        </div>
                        <div className="space-y-1">
                          <label className="text-xs font-semibold text-slate-400 uppercase">Expires</label>
                          <input className="w-full bg-slate-50 dark:bg-slate-800 border-primary/20 rounded-lg px-3 py-2 text-sm font-medium border-transparent" type="text" defaultValue="24 AUG 2029"/>
                        </div>
                      </div>
                      <div className="space-y-1">
                  ...
                  <div className="mt-8 flex gap-3">
                    <button className="flex-1 rounded-lg h-11 bg-primary text-white font-bold text-sm hover:bg-primary/90 transition-colors">Approve</button>
                    <button className="px-4 rounded-lg h-11 border border-[#ed3500]/20 text-[#ed3500] font-bold text-sm hover:bg-[#ed3500]/5 transition-colors" style={{borderColor: '#ed350044'}}>Flag</button>
                  </div>
                </div>
              </div>
            </div>
